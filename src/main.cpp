...
int main(void) {
  ...
  InputResolver::Init();
  RaylibHelper::Init(AppSettings::appSettings.screenWidth,
  ...
  LogicElements::LogicElementFactory::createGate(CircuitElements::ComponentType::AND,
                                                              and_gate_logger);
  auto gate2 =
      LogicElements::LogicElementFactory::createGate(CircuitElements::ComponentType::OR,
  or_gate_logger); auto gate3 =
  LogicElements::LogicElementFactory::createGate(CircuitElements::ComponentType::NOT,
                                                              not_gate_logger);
  auto gate4 =
  LogicElements::LogicElementFactory::createGate(CircuitElements::ComponentType::XAND,
                                                              xand_gate_logger);
  auto gate5 =
  LogicElements::LogicElementFactory::createGate(CircuitElements::ComponentType::XOR,
                                                              xor_gate_logger);*/
