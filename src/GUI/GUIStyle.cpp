...
namespace GUIStyle
{
    ...
    void SetFuturisticImGuiStyle()
    {
        ...
        //  Backgrounds
        colors[ImGuiCol_WindowBg] = ImVec4(.5f, 0.5f, 0.5f, 0.75f);
        ...
        style.Colors[ImGuiCol_ButtonHovered] =
            ImVec4(0.30f, 0.60f, 1.00f, 0.75f);  // Dynamic Hover Effect
        style.Colors[ImGuiCol_ButtonActive] =
            ImVec4(0.40f, 0.70f, 1.10f, 0.85f);  // Slightly More Intense Active Color
        ...
        std::string fontstr = PROJECT_ROOT_DIR +
